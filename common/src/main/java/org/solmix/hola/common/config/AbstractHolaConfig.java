...
public class AbstractHolaConfig extends InfoPropertiesSupport implements
    Serializable {

    private static final long serialVersionUID = -2463252429465944248L;

    protected static final Logger logger = LoggerFactory.getLogger(AbstractHolaConfig.class);
