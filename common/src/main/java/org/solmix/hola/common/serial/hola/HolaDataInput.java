...
import org.solmix.hola.common.serial.DataInput;

public class HolaDataInput implements DataInput,DataFlags
{
    ...
    public HolaDataInput(InputStream is)
    {
        this(is, 1024);
    }

    public HolaDataInput(InputStream is, int buffSize)
    {
        input = is;
    ...
    protected byte[] read0(int len) throws IOException
    {
          ...
          {
                System.arraycopy(buffer,position, ret, 0, rem);
                position = read;
