...
public class PropertiesUtils {
	...
	public static String[] ESCAPLES = new String[] { HOLA.ADDRESS_KEY, HOLA.PROTOCOL_KEY, HOLA.HOST_KEY, HOLA.PORT_KEY,
			HOLA.PATH_KEY, HOLA.USER_KEY, HOLA.PASSWORD_KEY, HOLA.MONITOR_KEY, HOLA.DISCOVERY_KEY };
	 ...
	 * @return
	 */
	public static String toAddress(Dictionary<String, ?> properties, boolean appendUser, boolean appendParameter,
			boolean useIP, boolean identity) {
		if (properties == null) {
			return null;
		}
		...
		if (!StringUtils.isEmpty(host)) {
			buf.append(NetUtils.getIpFormatString(host));
	...
	private static void buildQueryString(StringBuilder buf, boolean concat, boolean identity,
			Dictionary<String, ?> properties, String[] excluds) {
	...
	public static Dictionary<String, Object> toProperties(String address, Dictionary<String, Object> parameters) {
		...
		if (start_v6 != -1 && end_v6 != -1) {
			...
			address = address.substring(start_v6 + 1, end_v6);
			i = sport.indexOf(':');
			if (i > -1) {
	...
	public static Dictionary<String, ?> copyNotExist(Dictionary<String, Object> source,
	...
	public static void filterCopy(Dictionary<String, Object> source, Dictionary<String, Object> target,
			String... escapes) {
	...
	public static void makeConfigAsEndpointInfoExtension(ConfigSupportedReference config, EndpointInfo endpointInfo,
