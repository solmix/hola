...
/**
 * Hola remote service Admin,指定了Hola RSA中元数据的参数,关于OSGI中的元数据参考
 * {@link org.osgi.service.remoteserviceadmin.RemoteConstants} 或者<a
...
public class HolaRemoteConstants
{
    ...
    /**
     * 可选的Endpoint描述参数,配置远程连接ID,如果设置为非空,远程消费服务可以使用该ID,连接到指定的服务.
     */
    ...
    public static final Object SERVICE_IMPORTED_VALUETYPE = "service.imported.valuetype";;
