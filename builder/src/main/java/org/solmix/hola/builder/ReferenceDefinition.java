...
public class ReferenceDefinition extends AbstractReferenceDefinition {
    ...
    private ConsumerDefinition client;

    /**   */
    public ConsumerDefinition getClient() {
        return client;
    }

    /**   */
    public void setClient(ConsumerDefinition client) {
        this.client = client;
    }
