...
public class ConsumerDefinitionParser   extends AbstractBeanDefinitionParser{
	public ConsumerDefinitionParser() {
		super();
		setBeanClass(ConsumerDefinition.class);
	}
	...
	protected void parseElement(ParserContext ctx, BeanDefinitionBuilder bean,
		...
		if ("properties".equals(name)) {
			...
			BeanDefinition bd = new ReferenceDefinitionParser().parse(e, ctx);
