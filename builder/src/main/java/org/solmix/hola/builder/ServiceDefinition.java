...
public class ServiceDefinition<T> extends AbstractServiceDefinition implements ContainerAware
{
     ...
     * 一个服务可以通过多种协议发布
     */
    private List<ProviderDefinition> servers;
     ...
     * @return the servers
     */
    public List<ProviderDefinition> getServers() {
     ...
     */
    public void setServers(List<ProviderDefinition> servers) {
        this.servers = servers;
    }

    public ProviderDefinition getServer() {
        return servers == null || servers.size() == 0 ? null : servers.get(0);
    }

    public void setServer(ProviderDefinition server) {
        this.servers = Arrays.asList(new ProviderDefinition[] {server});
    }
