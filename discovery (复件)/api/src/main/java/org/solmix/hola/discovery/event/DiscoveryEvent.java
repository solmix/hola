...
/**
 * 服务监听事项,在{@link DiscoveryListener}中使用
 * 
...
public class DiscoveryEvent extends EventObject
{
    ...
    private final DiscoveryInfo metadata;

    public DiscoveryEvent(Object source,DiscoveryInfo metadata)
    {
        super(source);
     ...
     * @return
     */
    public DiscoveryInfo getServiceMetadata() {
        return metadata;
    }
}
