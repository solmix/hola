...
public class Activator implements BundleActivator
{
    ...
    public void start(BundleContext context) throws Exception {
        ...
        namespaceRegistration = this.context.registerService(Namespace.class.getName(), new JmDNSNamespace("Discovery Namespace"), null);
        String[] clazzes = new String[] { Discovery.class.getName(), DiscoveryAdvertiser.class.getName(), DiscoveryLocator.class.getName() };
    ...
    class JmDNSServiceFactory implements ServiceFactory<JmDNSProvider>
    {
        ...
        @Override
        public JmDNSProvider getService(Bundle bundle, ServiceRegistration<JmDNSProvider> registration) {
            if (service == null) {
                try {
        ...
        @Override
        public void ungetService(Bundle bundle, ServiceRegistration<JmDNSProvider> registration, JmDNSProvider service) {
