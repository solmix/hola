...
import org.solmix.hola.discovery.identity.DiscoveryIDImpl;
...
public class JmDNSDiscoveryID extends DiscoveryIDImpl
{
     ...
     * @param location
     */
    public JmDNSDiscoveryID(AbstractNamespace namespace,DiscoveryType type, URI location)
    {
