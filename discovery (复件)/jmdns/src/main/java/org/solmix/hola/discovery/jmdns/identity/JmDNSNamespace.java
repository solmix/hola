...
public class JmDNSNamespace extends AbstractNamespace
{
    ...
    public ID createID(Object[] parameters) throws IDCreateException {
        if (parameters == null || parameters.length < 1 || parameters.length > 2) {
            throw new IDCreateException("EndpointInfo cannot be null and must be of length 1 or 2");
        }
        String type = null;
        ...
        if (type == null) {
            if (parameters[0] instanceof DiscoveryType) {
                type = ((DiscoveryType) parameters[0]).getName();
            } else if (parameters[0] instanceof String) {
                type = (String) parameters[0];
            } else
                throw new IDCreateException("Service type id parameter has to be of type String or IDiscoveryTypeID");
