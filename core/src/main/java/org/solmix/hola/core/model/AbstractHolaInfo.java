...
public class AbstractHolaInfo extends InfoPropertiesSupport implements
    Serializable
{

    private static final long serialVersionUID = -2463252429465944248L;

    protected static final Logger logger = LoggerFactory.getLogger(AbstractHolaInfo.class);
