...
public class RemoteServiceInfo<T> extends AbstractServiceInfo implements ContainerAware
{
    /**    */
    ...
    public RemoteServiceInfo(T t){
        this(ContainerFactory.getThreadDefaultContainer(),t);
    }
    public RemoteServiceInfo(Container c,T t){
        this.container=c;
        this.ref=t;
    }
    /**   */
