 ...
 */
@ThreadSafe
public class EndpointInfo extends  ExtensionInfo<EndpointInfo>
{
     ...
     * @param remoteInfo2
     */
    public EndpointInfo(RemoteInfo remoteInfo)
    {
        this();
       this.remoteInfo=remoteInfo;
    }
    ...
    @Override
    protected EndpointInfo getSelf() {
        return this;
    }

    @Override
    protected EndpointInfo makeSelf(Map<String, Object> map) {
