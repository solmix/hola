...
public abstract class AbstractURIInfo<T> extends ExtensionInfo<T>
{
   ...
   /**
    ...
    public AbstractURIInfo(String protocol, String username, String password, String host, int port, String path, Map<String, Object> properties) {
        super(properties);
    ...
    public URI toURI(){
        if(uri==null){
            try {
                uri= new URI(protocol,getAuthority(),host,port,path,getQuery(),null);
    ...
    protected String getQuery() {
        ...
        boolean first = true;
        for (Map.Entry<String, Object> entry : new TreeMap<String, Object>(getProperties()).entrySet()) {
            if (entry.getKey() != null && entry.getKey().length() > 0){
                ...
                buf.append("=");
                buf.append(entry.getValue() == null ? "" : entry.getValue().toString().trim());
