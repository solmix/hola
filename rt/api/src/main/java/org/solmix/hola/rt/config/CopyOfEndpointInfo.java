...
public class CopyOfEndpointInfo extends  ExtensionInfo<CopyOfEndpointInfo>
{
    ...
    private List<DiscoveryConfig> discoveryConfigs;
    ...
    /**
     * @return the discoveryConfigs
     */
    public List<DiscoveryConfig> getDiscoveryInfos() {
        return discoveryConfigs;
    }

    /**
     * @param discoveryConfigs the discoveryConfigs to set
     */
    public void setDiscoveryInfos(List<DiscoveryConfig> discoveryConfigs) {
