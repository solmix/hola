...
import org.solmix.hola.rm.RemoteClientFactory;
import org.solmix.hola.rm.RemoteClientProxyFactory;
...
public class GenericClientProxyFactory extends RemoteClientProxyFactory {

    private static final long serialVersionUID = -3860608874988281080L;
    
    public GenericClientProxyFactory(){
        super(new GenericClientFactory());
    }
    
    public GenericClientProxyFactory(RemoteClientFactory factory) {
       super(factory);
    }
