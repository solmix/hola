...
public class GenericDelegate implements RemoteDelegate {
     ...
     * @param reference 
     */
    public GenericDelegate(Container container,NamedID serviceName) {
    ...
    public <T> T getProxy(NamedID name,Class<T> type,ReferenceConfig config) {
       ...
       GenericClientProxyFactory proxyFactory = new GenericClientProxyFactory();
       GenericClientFactory clientFactory=(GenericClientFactory)  proxyFactory.getClientFactory();
       GenericServiceFactory serviceFactory= (GenericServiceFactory)  proxyFactory.getServiceFactory();
